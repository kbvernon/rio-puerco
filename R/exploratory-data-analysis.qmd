...
```{r}
#| label: analysis-cer-regions-tbl
#| code-fold: true
...
```{r}
#| label: analysis-cer-abundance-tbl
#| code-fold: true
lbls <- tibble(
  y = 0.98,
...
```{r}
#| label: analysis-cer-abundance-mod
abundance <- abundance |>
  left_join(
...
```{r}
#| label: analysis-cer-abundance-mod-tbl
#| code-fold: true
tbl <- abundance_model |>
  tidy() |>
...
```{r}
#| label: analysis-cer-abundance-mod-fig
#| code-fold: true
site_area <- with(
  abundance,
...
```{r}
#| label: analysis-cer-abundance-mod-check
#| fig-align: center
#| out-width: 85%
check_model(
  abundance_model,
...
```{r}
#| label: analysis-cer-abundance-regions-mod
...
```{r}
#| label: analysis-cer-abundance-regions-mod-tbl
#| code-fold: true
...
```{r}
#| label: analysis-cer-abundance-regions-mod-fig
#| code-fold: true
dependence <- predict_response(
  regional_abundance_model,
  terms = list(
...
```{r}
#| label: analysis-cer-abundance-regions-mod-check
#| fig-align: center
#| out-width: 85%
check_model(
  regional_abundance_model,
...
```{r}
#| label: analysis-cer-correspondence
...
```{r}
#| label: analysis-cer-correspondence-fig
#| code-fold: true
...
```{r}
#| label: analysis-cer-correspondence-key
#| code-fold: true
keys <- ceramics |>
  filter(use == "decorated") |>
  group_by(type) |>
...
```{r}
#| label: analysis-cer-correspondence-regions
#| code-fold: true
gg_regions <- ggplot() +
  geom_hline(
    yintercept = 0,
...
```{r}
#| label: analysis-cer-correspondence-phases
...
```{r}
#| label: analysis-cer-correspondence-phases-fig
#| code-fold: true
...
```{r}
#| label: analysis-cer-correspondence-phases-fig2
#| code-fold: true
...
```{r}
#| label: analysis-cer-type-distributions
...
```{r}
#| label: analysis-cer-type-distributions-tbl
#| code-fold: true
tbl <- type_distributions |>
  pivot_wider(
    names_from = phase,
...
```{r}
#| label: analysis-site-characteristics
...
```{r}
#| label: analysis-site-characteristics-tbl
#| code-fold: true
...
```{r}
#| label: analysis-site-orientation-fig
#| code-fold: true
bb8 <- survey_area |>
  st_buffer(1000) |>
  st_bbox()
...
```{r}
#| label: analysis-cer-abundance-time-mod
abundance <- left_join(
  abundance,
...
```{r}
#| label: analysis-cer-abundance-time-mod-tbl
#| code-fold: true
...
```{r}
#| label: analysis-cer-abundance-time-mod-fig
#| code-fold: true
dependence <- predict_response(
  temporal_abundance_model,
  terms = list(
...
```{r}
#| label: analysis-cer-abundance-time-mod-check
#| fig-align: center
#| out-width: 85%
check_model(
  temporal_abundance_model,
...
```{r}
#| label: analysis-ware-distributions-fig
#| code-fold: true
tmp_labels <- paste0(
  "<span style='color: ",
  darken(region_colors, 0.2),
